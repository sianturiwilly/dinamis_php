...
<head>
	...
	<!-- Menghubungkan dengan file css --> <link rel="stylesheet" type="text/css" href="style.css">
...
<div class="content">
	...
	<div class="menu">
		<ul>
			<li><a href="index.php?page=home">HOME</a></li><li><a href="index.php?page=tentang">TENTANG</a></li>
